            ...
            <div class="car_notice">
              ...
              <div class="notice_list">
                <div class="notice_list_title">
                  <span class="title">{{$page_title("/notice/list")}}</span>
                </div>
                <router-link class="notice_block" v-for="(o, i) in list" :key="i" :to="'/notice/details?' + 'notice_id' + '=' + o.notice_id">
                  <div class="notice_title ellipsis_2">{{ o.title }}</div>
                  <div class="notice_create_time">{{ o.create_time| formatDate }}</div>
                </router-link>
              </div>
            </div>
          </div>
