            ...
            <div class="form_box">
              <b-form class="forms">
									...
									<b-form-group id="input-group-2" label="密码:" label-for="input-2" :state="validation_password" invalid-feedback="密码长度为5-16个字符" valid-feedback="校验通过">
										<b-form-input id="input-2" v-model="form.password" type="password" placeholder="请输入密码" trim></b-form-input>
									</b-form-group>

									<b-form-group id="input-group-2" label="确认密码:" label-for="input-2" :state="validation_confirm_password" invalid-feedback="两次密码不一致" valid-feedback="校验通过">
										<b-form-input id="input-2" v-model="confirm_password" type="password" placeholder="请再次输入密码" trim></b-form-input>
									</b-form-group>

									<b-form-group id="input-group-2" label="邮箱:" label-for="input-2" :state="validation_email" invalid-feedback="邮箱格式example@123.com" valid-feedback="">
										<b-form-input id="input-2" v-model="form.email" type="email" placeholder="请输入邮箱" trim></b-form-input>
									</b-form-group>

									<b-form-group id="input-group-2" label="验证码:" label-for="input-2" :state="validation_code" invalid-feedback="验证码错误">
										<b-input-group>
											<b-form-input id="input-2" v-model="form.code" type="text" placeholder="请输入验证码" trim></b-form-input>
