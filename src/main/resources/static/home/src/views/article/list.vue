                ...
                <div class="row art_warp">
                    <div class="col-12 col-md-9 ">
                        <div class="card_article h-100 mb">
                            <div class="article_list_title">
                                <span class="title">{{$page_title("/article/list")}}</span>
                            </div>
                            <div class="leis_box">
                                <div class="iudis_box">
                                    <!-- 搜索栏 -->
                                    <div class="search_box">
                                        <b-form-input size="sm" class="mr-sm-2" placeholder="局部搜索" v-model.trim="search_val" @keyup.enter="submit_search"/>
                                    ...
                                    <div class="filter_block">
                                        ...
                                        <div class="bar_filter">
                                            <b-dropdown :text="title" variant="outline-dark" left>
                                                <b-dropdown-item v-for="(o, i) in list_article_type" :key="i" @click="filter_article(o)">
                                                    {{ o }}
                                                </b-dropdown-item>
                                            </b-dropdown>
                                        </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="card_article_hot">
                            <div class="hot_title">
                                {{$page_title("/article/list")+"热门列表"}}
                            </div>
                            <!-- 资讯热门列表card_article_hot -->
