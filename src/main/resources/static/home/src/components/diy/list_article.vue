<template>
	<nav class="list_article list list-x item-tb">
		<!-- 资讯详情 -->
		<router-link class="article_warp" v-for="(o, i) in list" :key="i" :to="'/article/details?' + vm.article_id + '=' + o[vm.article_id]">
			<div class="article">
				<div class="media">
					<div class="icon">
						<img :src="o[vm.img] ? $fullUrl(o[vm.img]) : '../../../public/img/default.png'" v-default-img="'../../../public/img/default.png'" />
					</div>
				</div>
				<div class="doc">
