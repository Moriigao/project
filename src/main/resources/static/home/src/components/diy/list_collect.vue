<template>
  <div class="list_collect">
    <div class="item_collect" v-for="(o, i) in list" :key="i">
      <router-link class="collect_box" :to="'/' +o[vm.source_table] +'/details?' +o[vm.source_field] +'=' +o[vm.source_id]">
        <div class="left_block">
          <img style="width: 3rem; height: 3rem" :src="o[vm.img] ? $fullUrl(o[vm.img]) : '../../../public/img/default.png'"/>
        </div>
