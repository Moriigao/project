<template>
	<el-main class="bg table_wrap messge">
		...
		<el-table border :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" stripe>
			...
			<el-table-column label="标题" prop="title" sortable min-width="160"></el-table-column>

			<el-table-column label="昵称" prop="nickname" sortable min-width="100"></el-table-column>

      <el-table-column label="内容" prop="content" sortable min-width="140"></el-table-column>
    ...
    <el-dialog title="回复" :visible.sync="showModal">
      <quill-editor v-if="is_check" class="editor el_form_editor_warp" v-model="form.reply"></quill-editor>
