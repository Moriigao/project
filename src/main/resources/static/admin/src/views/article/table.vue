<template>
	<el-main class="bg table_wrap article">
		...
		<el-table border :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" stripe>
			<el-table-column fixed type="selection" tooltip-effect="dark" width="50"></el-table-column>
			<el-table-column fixed sortable prop="title" label="标题" width="250"></el-table-column>
			...
			<el-table-column sortable prop="type" label="资讯分类" min-width="120"></el-table-column>

			<el-table-column prop="tag" label="标签" min-width="180"></el-table-column>
