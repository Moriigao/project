export default {
    data: function data() {
        return {
            ...
            select: $.db.get('select'),	// 选中项
            count: 0,	// 查询结果匹配数统计
            bl: false,	// 响应成功或失败
            field: "",	// 关键字段
            tip: "",	// 响应提示
            clear_list: true,	// 清除列表
            message: "",	// 响应错误消息
            selects: "",	// 选中集
            page_now: 1,	// 当前页, 用于跳转页面
            select_state: false,	// 选择项状态
            query_set: {},  // 修改条件
            selection: [],  // 选中集合
            // 登录权限
            oauth: {
            ...
            user: this.$store.state.user,   // 登录用户
            tip_show: true, // 修改提示
            user_group: this.$store.state.user.user_group   // 所在用户组
        };
    },
    methods: {
        /**
        ...
        add: function add(param, func) {
            ...
            var ret = this.events("add_main", param, func);  // 直接调用 add_main 处理数据
            return ret;
        },
        ...
        del: function del(param, func) {
            ...
            var ret = this.events("del_main", param, func);  // 直接调用 del_main 处理数据
            return ret;
        },
        ...
        set: function set(param, query, func, includeZero) {
            ...
            var ret = this.events("set_main", pm, func);
            return ret;
        },
        ...
        get_list: function get_list(param, func) {
            ...
            var ret = this.events("get_list_main", param, func);  // 直接调用 get_list_main 处理数据
            return ret;
        },
        ...
        get_obj: function get_obj(param, func) {
            ...
            var ret;
            if (!msg) {
                ret = this.events("get_obj_main", param, func);
            } else if (func) {
                func();
            }
            return ret;
        ...
        init: function init(param, func) {
            ...
            var ret = this.events("init_main", pm, func);
            return ret;
        },
        ...
        upload: function upload(param, func) {
            var ret = this.events("upload_main", param, func);
            return ret;
        },
        ...
        submit: function submit(param, func) {
            ...
            var ret = this.events("submit_main", pm, func);
            // 返回结果
            return ret;
        },
